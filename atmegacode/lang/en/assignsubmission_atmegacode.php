...
$string['warning_hex_newer'] = '⚠️ HEX file "{$file}" in folder "{$folder}" is significantly newer than the latest .c/.h file. Please ensure the correct version is compiled.';
